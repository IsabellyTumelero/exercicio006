/*
Troca Variáveis
Este exemplo pede ao usuário que informe dois valores inteiros e o armazena em duas variáveis. 
...
programa 
{
  funcao inicio() 
  {
    ...
    /*
     *  Realize a troca dos valores contidos nas variáveis. É necessário utilizar
